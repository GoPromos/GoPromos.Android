...
import br.com.gopromos.android.config.AnalyticsConfig;
import br.com.gopromos.android.config.CrashlyticsConfig;
import br.com.gopromos.android.config.FrescoConfig;
import br.com.gopromos.android.config.RemoteConfig;
...
public abstract class App extends Application implements HasActivityInjector {
	public static final String SHARED_PREFERENCES = "br.com.gopromos.android.shared_prefs";
	public static final String DATABASE = "br.com.gopromos.android.database";
